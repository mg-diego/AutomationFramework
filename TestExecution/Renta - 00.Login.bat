...
vstest.console.exe "C:\GIT\Renta\TestAutomation\US.AcceptanceTests\bin\Debug\US.AcceptanceTests.dll" /Logger:trx /TestCaseFilter:"TestCategory=Story:Login"
...
cd C:\GIT\Renta\TestAutomation\US.AcceptanceTests\bin\Debug\TestResults
...
xcopy /s %NewestFile% "C:\GIT\Renta\TestAutomation\US.AcceptanceTests\bin\Debug\TestResults\%NewestFolder%" /Y
echo Copy to TestReports:
xcopy /s %NewestFile% C:\GIT\Renta\TestAutomation\TestReports /Y



:: Generate new HTML file
@echo off
cd C:\GIT\Renta\TestAutomation\TestReports
echo. 
...
@echo off
setlocal
set "yourDir=C:\GIT\Renta\TestAutomation\TestReports"
set "yourExt=*.html"
pushd %yourDir%
...
echo Copy to TestResults:
xcopy /s %htmlFile% "C:\GIT\Renta\TestAutomation\US.AcceptanceTests\bin\Debug\TestResults\%NewestFolder%" /Y
%SystemRoot%\explorer.exe "C:\GIT\Renta\TestAutomation\US.AcceptanceTests\bin\Debug\TestResults\%NewestFolder%\"
@echo off
popd
endlocal
pause
